...
const sendAgreementsRouter = require('./routes/sendAgreementsRouter');
const viewDocumentsRouter = require('./routes/viewDocumentsRouter');
...
app.use('/sendAgreements', sendAgreementsRouter);
app.use('/viewDocuments', viewDocumentsRouter);
